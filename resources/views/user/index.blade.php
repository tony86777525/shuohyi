...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section data-section="0" class="top-banner">
            <div class="top-banner__content wow animate__animated animate__fadeInRightShort">
                <div class="topic">
                    <h1 class="topic__company">碩誼有限公司</h1>
                ...
                <div class="about-us__content">
                    ...
                    <div class="about-us__content--intro">
                        <div class="intro">
                            <div class="intro--txt">
                                <div class="part">
                                    <p class="part--topic">在地深耕</p>
                                    <p class="part--txt">熟悉台灣產業需求，提供最貼心的服務。</p>
                                </div>
                                <div class="part">
                                    <p class="part--topic">經驗豐富</p>
                                ...
                                <div class="part">
                                    <p class="part--topic">品質保證</p>
                                    <p class="part--txt">嚴格品管，確保產品品質。</p>
                                </div>
                                <div class="part">
                                    <p class="part--topic">不斷創新</p>
                                    <p class="part--txt">與時俱進，引領產業潮流。</p>
                                </div>
                            </div>
                    ...
                    <div class="service__content--part">
                        <div class="part">
                            <div class="part__content">
                                <div class="part__content--topic">自動化設備設計與製造 — 提升效率與精度的智能解決方案</div>
                                <div class="part__content--txt">
                        ...
                        <div class="part">
                            <div class="part__content">
                                <div class="part__content--topic">客製化機架燒焊與機台組裝 — 打造符合您需求的專屬解決方案</div>
                                <div class="part__content--txt">
                        ...
                        <div class="part">
                            <div class="part__content">
                                <div class="part__content--topic">鋼構機械藝術品製作</div>
                                <div class="part__content--txt">
        ...
        <section data-section="3" class="contact-us">
            <div class="container">
                <div class="contact-us__content">
                    ...
                    <div class="about-us__content--intro">
                        <div class="intro">
                            <div class="intro--topic">客戶至上，創新無限</div>
                            <div class="intro--txt">
                            ...
                            <div class="form__content">
                                <div class="formRow formRow--single required">
                                    <label class="formCol">
                                        ...
                                        <input type="text" name="username" class="formEl formEl--txtIpt">
                                    </label>
                                </div>
                                <div class="formRow formRow--partial">
                                    <div class="formCol">
                                        <input id="sex_1" type="radio" name="sex" value="1" class="formEl formEl--radio">
                                ...
                                <div class="formRow formRow--single required">
                                    <label class="formCol">
                                        ...
                                        <textarea name="" class="formEl formEl--txtArea" rows="8"></textarea>
                                    </label>
                                </div>
                                <div class="formRow formRow--single required">
                                    <label class="formCol">
